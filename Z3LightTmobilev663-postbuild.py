...
def S37():
    ...
    if ("gcc" == "iar" or "gcc" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/Applications/Simplicity%20Studio.app/Contents/Eclipse/developer/toolchains/gnu_arm/7.2_2017q4/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    print (" ")
    EBL_COMMAND = START_FLAGS + shortPath(r"/Applications/Simplicity Studio.app/Contents/Eclipse/developer/adapter_packs/commander/Commander.app/Contents/MacOS/commander").replace(
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"/Applications/Simplicity Studio.app/Contents/Eclipse/developer/adapter_packs/commander/Commander.app/Contents/MacOS/commander").replace(
