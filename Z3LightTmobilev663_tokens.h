...
#define CREATOR_COLOR_CONTROL_COLOR_TEMPERATURE_2 0xB006
#define NVM3KEY_COLOR_CONTROL_COLOR_TEMPERATURE_2 ( NVM3KEY_DOMAIN_ZIGBEE | 0xB006 )
// Creator for attribute: start up color temperature mireds, endpoint: 2
#define CREATOR_START_UP_COLOR_TEMPERATURE_MIREDS_2 0xB007
#define NVM3KEY_START_UP_COLOR_TEMPERATURE_MIREDS_2 ( NVM3KEY_DOMAIN_ZIGBEE | 0xB007 )
